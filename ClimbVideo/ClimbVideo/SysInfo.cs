  ...
  public   class SysInfo
    {
        ...
        /// 定义雄迈相机
        /// </summary>
        public static Clb_XmCam_DLL.Clb_XmCam m_Cam_Xm = new Clb_XmCam();
        public static int m_iW_iMG = 0;
        public static int m_iH_iMG = 0;
        public static int m_iW_iMG_L = 0;
        public static int m_iH_iMG_L = 0;
        public static int m_iW_iMG_R = 0;
        public static int m_iH_iMG_R = 0;
        public static int m_iW_iMG_M = 0;
        public static int m_iH_iMG_M = 0;
        public static int m_i_Curr_H = 0;

        /// <summary>
        ///  300万相机像素 高度
        /// </summary>
        public static int m_iH_iMG_4 = 1296;

        public static int m_iW_iMG_4 = 2304;
        /// <summary>
        /// 录像计时显示点击界面字符：开始录像
        /// </summary>
        public static int m_iStart_V = 0;
        /// <summary>
        /// 是否已经发送状态给服务器
        /// </summary>
        public static bool m_blSendServLinkState = false;
        /// <summary>
        /// 加载MIND相机
        /// </summary>
     //   public static bool m_bl_Add_MindCam = false;

        public static csInterface m_csInter = new csInterface();
        /// <summary>
        /// 是否网络相机
        /// </summary>
        public static  bool m_blIP = true;
        /// <summary>
        /// 网络相机实时数据
        /// </summary>
        ...
        /// 前视
        /// </summary>
        public static Emgu.CV.Image<Emgu.CV.Structure.Bgr, byte> m_ImgDat_L;
        /// <summary>
        /// 后视
        /// </summary>
        public static Emgu.CV.Image<Emgu.CV.Structure.Bgr, byte> m_ImgDat_R;
        /// <summary>
        /// 中视：探头
        /// </summary>
        public static Emgu.CV.Image<Emgu.CV.Structure.Bgr, byte> m_ImgDat_M;

        /// <summary>
        /// 右视：探头
        /// </summary>
        public static Emgu.CV.Image<Emgu.CV.Structure.Bgr, byte> m_ImgDat_4;

        public static System.Timers.Timer Time_Video = new System.Timers.Timer();
        /// <summary>
        /// 网络相机
        /// </summary>
        public static  CameNet.NetworkCamera m_Cam = new CameNet.NetworkCamera();
        /// <summary>
        /// 摄像拍照
        /// </summary>
        public static  Video.ClassVideo g_USB_Video = new Video.ClassVideo();
        /// <summary>
        /// 录像开关 1:开始  0：结束
        /// </summary>
        ...
        /// 开始录像时间
        /// </summary>
        public static DateTime m_strTime;
        /// <summary>
        /// 视频
        /// </summary>
     //   public static  FrameWork.Struct.ClassVideo g_Video = new FrameWork.Struct.ClassVideo();

        /// <summary>
        /// 视频信息
        /// </summary>
        public static string m_strVideoMsg = "";
        /// <summary>
        ///  镜头 1：前视 3：探头  2：后视
        ///  重新定义：0:前后左右 1：前视  中视  2 前视 后视  3 前视  4 中视  5 后视
        /// </summary>
        public static int m_iF_B = 0;
        /// <summary>
        ...
        /// 选中
        /// </summary>
        public static int m_i_Select = 3;
        /// <summary>
        /// true:一半  false:单窗口
        /// </summary>
        public static bool m_bl_Qhzy_50T_100F = true;
        /// <summary>
        /// 前中后相机是否翻转
        /// </summary>
        public static string m_str_ABC = "000";
