/*-----------------------------------------------------------------------------
 * Copyright(C) 2015 深圳普禄科软件有限公司 
 * 文件名: DBConvert.cs
 * 文件功能描述: 数据库类型转换类。类型不符或字段值为空时 返回默认值(Int32返回0,string 返回"")
 * 创建标识: 陈大伟  2013.3.13
 * 修改标识:
 * 修改描述:
/*-----------------------------------------------------------------------------*/
...
namespace ClassLib_DataMang.DataBaseMang.DBUtility
{
    ...
    public static class DBConvert
    {
        ...
        public static int ToInt32(object obj)
        {
            ...
            else if (obj != null && obj is System .Enum) //处理非null值类型时(或者枚举)
            {
        ...
        public static double ToDouble(object obj)
        {
            ...
            else if (obj != null && obj is System .Enum) //处理枚举
            {
