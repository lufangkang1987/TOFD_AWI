...
namespace NetClient
{
    ...
    {       
        ...
        /// 设置相机时间段通用参数
        /// </summary>
        /// <param name="_iLogonID">LogonID</param>
        /// <param name="_iChannel">通道号</param>
        /// <param name="_iFuncID">时间段  255的时候是即时值 </param>
        /// <param name="_lpBuf">存储参数缓冲区指针</param>
        /// <param name="_iSize">存储参数缓冲区大小</param>
        /// <returns></returns>
        [DllImport("NVSSDK.dll", SetLastError = true)]
        public static extern Int32 NetClient_SetHDTimeRangeParam(int _iLogonID, int _iChannel, int _iFuncID, ref ITS_TTimeRangeParam _lpBuf, int _iSize);
        /// <summary>
        /// 获取相机时间段通用参数
        /// </summary>
        /// <param name="_iLogonID">LogonID</param>
        /// <param name="_iChannel">通道号</param>
        /// <param name="_iFuncID">时间段</param>
        /// <param name="_lpBuf">存储参数缓冲区指针</param>
        /// <param name="_iSize">存储参数缓冲区大小</param>
        /// <returns></returns>
        [DllImport("NVSSDK.dll", SetLastError = true)]
        public static extern Int32 NetClient_GetHDTimeRangeParam(int _iLogonID, int _iChannel, int _iFuncID, ref ITS_TTimeRangeParam _lpBuf, int _iSize);

        /// <summary>
        /// 设置取原始帧数据的回调函数
        /// </summary>
        /// <param name="_iLogonID"></param>
        /// <param name="_cbkYUVData"></param>
        /// <param name="_pContext"></param>
        /// <returns></returns>
        [DllImport("NVSSDK.dll", SetLastError = true)]
        public static extern Int32 NetClient_SetRawFrameCallBack(UInt32 _iLogonID, RAWFRAME_NOTIFY _cbkYUVData, IntPtr _pContext);

        [DllImport("NVSSDK.dll", SetLastError = true)]
        public static extern Int32 NetClient_DrawTextOnVideo(int _iLogonID, UInt32 _iChannelNum, UInt32 _iX, UInt32 _iY, string _cText, UInt32 _iStore, UInt32 _iStreamNO);

        [DllImport("NVSSDK.dll", SetLastError = true)]
        public static extern Int32 NetClient_SetDecCallBack(UInt32 _iLogonID, DECYUV_NOTIFY _cbkYUVData, IntPtr _pContext);
