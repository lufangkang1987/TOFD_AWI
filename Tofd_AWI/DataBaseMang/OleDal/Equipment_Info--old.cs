...
{
    public class Manage_Equipment_Info
    {
        /// <summary>
        /// 操作的数据表名称
        /// </summary>
...
(_iDataBase_Type == 0 ? " flNormal_Thickness    Single  NULL , " : "iFirstTest float  NULL, ") +//公称厚度
(_iDataBase_Type == 0 ? " flNormal_Thickness_2    Single  NULL , " : "iFirstTest float  NULL, ") +//公称厚度2
...
" strOther_3    varchar(20)  NULL , " +//备用3
...
" ReMark    varchar(200)  NULL "; //备注
            ...
            { System.Windows.Forms.MessageBox.Show("Manage_Equipment_Info.cs的 Creat_Table error：" + e.Message + e.StackTrace + " " + strSQL); }
            return _blRet;
        }
        public bool Creat_Table_Bad()
        {
            bool _blRet = false;
            string strSQL = "", strFileName = ""; ;
            try
            {
                #region 字段表
                strFileName = " ID varchar(20)     NOT NULL," +//ID号
                             " strDwmc    varchar(50) NOT  NULL , " +//单位名称------------
                              "strDwbh    varchar(50) NOT  NULL , " +//单位名称------------
                             " strSetName    varchar(50) NOT  NULL , " +//管道设备名称
                             " strJyrq    varchar(18)  NULL , " +//检验日期
...
" ReMark    varchar(200)  NULL "; //备注
        ...
        public bool DeleteDat()
        {
            ...
            { System.Windows.Forms.MessageBox.Show("Manage_Equipment_Info.cs的DeleteDaterror：" + e.Message + e.StackTrace + " " + strSQL); }
            return _blRet;
        }
        /// <summary>
        /// 删除指定ID数据
        ...
        public int UpData_Data(string strDwmc,string strSetName,string strAdd_Dz,string strJyrq,string strArae, ref Class_Equipment_Info _Infor)
        {
            ...
            { System.Windows.Forms.MessageBox.Show("Manage_Equipment_Info.cs的SaveData_Tmperror：" + e.Message + e.StackTrace + " " + strSQL); }
        ...
        public int SaveData(ref Class_Equipment_Info _Infor)
        {
            int iRet = 0;
            string strSQL = "";
            string strAdd_Val = "";//增加Sql值
                    ...
                    case 0:
                        ...
                        if (dt != null && dt.Rows.Count > 0)
                        {
                            ...
                            foreach (DataRow dr in dt.Rows)
                            {
                                ...
                                _Infor.strOther_3 = DBConvert.ToString(dr["strOther_3"]);
