...
namespace FrameWork.DataBaseMang.OleDal
{
    ...
    public static class DbGlobal
    {
        ...
        /// 2 距离厚度数据管理类接口
        /// </summary>
        public static Manage_DistanceThick ImDistanceThick = new Manage_DistanceThick();
        /// <summary>
        /// 3 设备信息数据管理类接口
        /// </summary>
        public static Manage_Test_Item ImText_Item = new Manage_Test_Item();
        /// <summary>
        /// 4 波形信息数据管理类接口
        /// </summary>
        public static Manage_Wave ImWave = new Manage_Wave();
