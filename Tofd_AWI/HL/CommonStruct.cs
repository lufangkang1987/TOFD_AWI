...
namespace NetClient
{
    ...
    struct RAWFRAME_INFO
    {
        public UInt32 nWidth;
        public UInt32 nHeight;
        public UInt32 nStamp;
        public UInt32 nType;
        public UInt32 nEnCoder;
        public UInt32 nFrameRate;
    ...
    delegate void RAWFRAME_NOTIFY(UInt32 _ulID, IntPtr _pData, Int32 _iLen, ref RAWFRAME_INFO _pRawFrameInfo, IntPtr _pContext);
    ...
    delegate void ReplayCallBackDelegate(UInt32 _ulID, IntPtr _ucData, Int32 _iLen, Int32 _iFlag, Int32 _lpUserData);
    ...
    public class HDParaType
    {
         ...
         *  15--lut使能
         *  16--自动亮度调节使能*/
        public const int HD_PARA_APERTURE = 0;                  //0-Image Adjustment
        public const int HD_PARA_WIDE_DYNAMIC = 1;             //1-Wide dynamic policy
        public const int HD_PARA_BACK_LIGHT = 2;                    //2-BackLight Compensation
        public const int HD_PARA_EXPOSAL_TIME = 3;                       //3-Exposal Time
        /// <summary>
        /// 快门调节
        /// </summary>
        public const int HD_PARA_SHUTTER = 4;                   //4-Shutter adjustment
        /// <summary>
        /// 增益调节
        /// </summary>
        public const int HD_PARA_GAIN = 5;              //5-Gain adjustment
        /// <summary>
        /// gamma调节
        /// </summary>
        public const int HD_PARA_GAMMA = 6;                 //6-Gamma type
        /// <summary>
        /// 锐度调节
        /// </summary>
        public const int HD_PARA_SHARPNESS = 7;             //7-Sharpness adjustment
        public const int HD_PARA_DNR = 8;               //8-Noise Reduction adjustment
        public const int HD_PARA_EXPOSAL_AREA = 9;              //9-Exposure area
        public const int HD_PARA_BACK_LIGHT_AREA = 10;                  //10-BLC area
        public const int HD_PARA_AF_AREA = 11;              //11-AF area set
        /// <summary>
        /// 目标亮度调节
        /// </summary>
        public const int HD_PARA_BRIGHTNESS_HD = 12;                //12-Brightness
        public const int HD_PARA_WHITE_BALANCE = 13;                //13-White Balance
        public const int HD_PARA_JPEG_QUALITY = 14;             //14-JPEG Quality
        public const int HD_PARA_LUT_ENABLE = 15;                   //15-LUT enable
        public const int HD_PARA_AUTO_BRIGHTNESS = 16;                  //16-Enabling automatic brightness adjustment
        public const int HD_PARA_STRONG_LIGHT = 17;             //17-Light Suppression
        public const int HD_PARA_EXPO_MODE = 18;                //18-Exposure mode
        public const int HD_PARA_INOUT_DOOR_MODE = 19;              //19-Indoor and outdoor mode
        public const int HD_PARA_FOCUS_MODE = 20;                   //20-Focus Mode
        public const int HD_PARA_MIN_FOCUS_DISTANCE = 21;                   //21-Minimum focusing distance
        public const int HD_PARA_DAY_NIGHT = 22;                //22-Day & Night Mode
        public const int HD_PARA_RESTORE_DEFAULT = 23;                  //23-reset
        public const int HD_PARA_THROUGH_MIST = 24;             //24-Through fog
        public const int HD_PARA_AE_SPEED = 25;             //25-Automatic exposure adjustment
        public const int HD_PARA_SMARTIR = 26;              //26-smartIR
        public const int HD_PARA_OFFSET_INCREASE = 27;                  //27-Exposure Compensation
        public const int HD_PARA_SENSETIVE = 28;                //28-High Sensitivity
        public const int HD_PARA_AUTO_SLOW_EXPO = 29;               //29-Auto slow exposure
        public const int HD_PARA_AUTO_CONTRAST = 30;                //30-Auto Contrast
        public const int HD_PARA_VIDEO_FROST = 31;                  //31-Image freeze
        public const int HD_PARA_INFRARED = 32;                 //32-Infrared Calibration
        public const int HD_PARA_COLOR_INCREASE = 33;                   //33-Color gain
        public const int HD_PARA_COLOR_PHASE = 34;              //34-Color phase
        public const int HD_PARA_LIGHTLESS = 35;                //35-Low light color suppression
        public const int HD_PARA_FOCUS_TYPE = 36;                   //36-Focus Type
        public const int HD_PARA_NIGHT_STRENTH = 37;                //37-Night strengthen
        public const int HD_PARA_VIGNETTE = 38;                 //38-Vignette compensation
        public const int HD_PARA_BRIGHTNESS_EX = 39;                //39-Brightness
        public const int HD_PARA_CONTRAST_HD = 40;                  //40-Contrast
        public const int HD_PARA_SATURATION_HD = 41;                //41-saturation
        public const int HD_PARA_HUE_HD = 42;				//42-Chroma
    }
    [StructLayout(LayoutKind.Sequential)]
    public struct ITS_TTimeRangeParam
    {
        public int iType;
